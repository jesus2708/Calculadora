#include "stdafx.h"  //________________________________________ CalculatorWeb.cpp
#include "CalculatorWeb.h"
...
BOOL WINAPI GetExtensionVersion(HSE_VERSION_INFO* pVer)
{
	...
	strcpy_s(pVer->lpszExtensionDesc, HSE_MAX_EXT_DLL_NAME_LEN, "CalculatorWeb ISAPI Extension");
